...
// CS 251: Fall 2021
//
// To implement my creative component simply uncomment line 45 - 50 and run the program. The code will ask the user for a frame to be displayed.
...
int main() {
 ...
 /* system("clear");
  ...
  string frame = "";
  cin >> frame;
  bca.animateframe(cout, 12, 1, frame);
*/
    return 0;
}
