...
class Scale extends StatefulWidget {
  @override
  _Scale createState() => _Scale();
}

/*
 * Extend the class WidgetLayoutController
 */
class _Scale extends State<Scale> with TickerProviderStateMixin{
              ...
              child: Container(
                  ...
                  Column(
                    children: [
                      ...
                      Text("The Scale Transition is an animation which scales the size of it's child Widget.\n\nThis explicitly created to scale infinetely.",
                ...
                child: Center(
                    child: Column(
                        children: [
                          ...
                          ScaleTransition(scale: turn_tween.animate(_animation),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("SCALE TRANSITION", style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold),),
      ),
